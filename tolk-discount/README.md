# Tolk v3.0 - Платформа скидок нового поколения

Многоплатформенная система с нативными мобильными приложениями, PWA и веб-версией с дизайном Liquid Glass.
...
| [📱 План развития продукта v3.0](./docs/PRODUCT_DEVELOPMENT_PLAN.md) | **НОВОЕ** - Полный план развития платформы |
| [📲 Мобильное приложение](./mobile/README.md) | **НОВОЕ** - Документация Flutter приложения |

---

## 🎯 Версии продукта v3.0

### 1. Нативное мобильное приложение (iOS + Android)
- **Технология**: Flutter
- **Дизайн**: Liquid Glass (glassmorphism)
- **Размер**: < 50MB
- **Производительность**: запуск < 2s, 60 FPS
- **Функции**:
  - Регистрация по телефону (SMS) и email
  - Персональная статистика использования скидок
...
- **Технология**: Next.js 14 + next-pwa
- **Дизайн**: Аналогичен мобильному приложению (Liquid Glass)
- **Функции**:
...
- **Дизайн**: Liquid Glass дизайн-система
- **Компоненты**: GlassCard, GlassButton, GlassTextField, GlassHeader
- **Страницы**:
  - Публичные: главная, каталог, скидки, категории, магазины
  - Защищенные: личный кабинет, профиль, избранное, настройки
...
- **По номеру телефона** (основной способ)
  - Ввод номера → SMS код → создание профиля
- **По email** (альтернативный)
  - Ввод email → письмо с ссылкой → создание профиля
- **Социальные сети** (опционально)
  - Google, Apple, VK, Яндекс

### Функционал личного кабинета
- ✅ Профиль с аватаром
- ✅ Персональная статистика (сэкономленные деньги, использованные скидки)
- ✅ Избранные скидки и подборки
- ✅ Персональные предложения
- ✅ Семейные карты
...
GET    /api/v1/statistics/summary     # Статистика
...
```css
.glass {
  @apply relative backdrop-blur-xl bg-white/10 
         border border-white/20 rounded-2xl shadow-lg;
}

.glass-card {
  @apply glass before:absolute before:inset-0 
         before:bg-gradient-to-br before:from-white/10;
}

.glass-button-primary {
  @apply glass bg-blue-500/20 hover:bg-blue-500/30 
...
- `GlassHeader` - заголовок страницы

### Flutter виджеты
- `GlassCard` - аналог для мобильного приложения
- `GlassButton` - кнопка
